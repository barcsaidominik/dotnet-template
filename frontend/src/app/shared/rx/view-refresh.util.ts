...
import { Observable, auditTime, filter, fromEvent, merge } from 'rxjs';

export function createViewRefresh$(router: Router, routePrefix: string): Observable<Event | NavigationEnd> {
