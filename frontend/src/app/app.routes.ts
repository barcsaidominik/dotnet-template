    ...
    children: [
      {
        path: 'login',
        loadComponent: () =>
          import('./features/auth/login/login.component').then((m) => m.AuthLoginComponent),
      },
      {
        path: 'register',
        loadComponent: () =>
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: 'facilities',
            loadComponent: () =>
              import('./features/admin/facilities/admin-facilities.component').then(
        ...
        children: [
          {
            path: 'users',
            loadComponent: () =>
              import('./features/facility/users/facility-users.component').then(
                (m) => m.FacilityUsersPageComponent
              ),
          },
          {
            path: 'products',
            loadComponent: () =>
              import('./features/facility/products/facility-products.component').then(
                (m) => m.FacilityProductsPageComponent
              ),
          },
          { path: '', redirectTo: 'users', pathMatch: 'full' },
        ],
      },
      {
        ...
        loadComponent: () =>
          import('./features/products/products.component').then((m) => m.ProductsPageComponent),
      },
      {
        path: 'mailbox',
        loadComponent: () =>
          import('./features/mailbox/mailbox.component').then((m) => m.MailboxPageComponent),
      },
    ],
  },
