...
public static class DbSeeder
{
    ...
    public static async Task SeedSystemAdminAsync(IServiceProvider serviceProvider)
    {
        ...
        if (user.PasswordHash is null)
        {
            ...
            logger.LogWarning("Initial SystemAdmin setup token generated for {Email}. Használd egyszer a /api/auth/set-password végponttal. Token: {Token}", SYSTEM_ADMIN_EMAIL, setupToken);
        }
    }
}
